...
func New(svc user.Service, logger jobsity.Logger) *LogService {
	return &LogService{
		Service: svc,
		logger:  logger,
	}
...
type LogService struct {
	user.Service
	logger jobsity.Logger
}

const name = "user"

// Create logging
func (ls *LogService) Create(c echo.Context, req jobsity.User) (resp jobsity.User, err error) {
...
// List logging
func (ls *LogService) List(c echo.Context, req jobsity.Pagination) (resp []jobsity.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// View logging
func (ls *LogService) View(c echo.Context, req int) (resp jobsity.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// Update logging
func (ls *LogService) Update(c echo.Context, req user.Update) (resp jobsity.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
