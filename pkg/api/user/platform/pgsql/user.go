...
func (u User) Create(db orm.DB, usr jobsity.User) (jobsity.User, error) {
	...
	if err == nil || err != pg.ErrNoRows {
		return jobsity.User{}, ErrAlreadyExists
	}
...
func (u User) List(db orm.DB, qp *jobsity.ListQuery, p jobsity.Pagination) ([]jobsity.User, error) {
	var users []jobsity.User
...
func (u User) Delete(db orm.DB, user jobsity.User) error {
