...
func TestAuthenticate(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (jobsity.User, error) {
		...
		},
		{
			...
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (jobsity.User, error) {
					return jobsity.User{Username: user}, nil
				},
			},
			sec: &mock.Secure{
		...
		},
		{
			...
			jwt: &mock.JWT{
				GenerateTokenFn: func(u jobsity.User) (string, error) {
		...
		},
		{
			...
			udb: &mockdb.User{
				...
				UpdateFn: func(db orm.DB, u jobsity.User) error {
					return jobsity.ErrGeneric
				},
			},
			sec: &mock.Secure{
...
func TestRefresh(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByTokenFn: func(db orm.DB, token string) (jobsity.User, error) {
					return jobsity.User{}, jobsity.ErrGeneric
				},
			},
		},
