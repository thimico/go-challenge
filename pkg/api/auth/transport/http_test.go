...
import (
	...
	"my-chat-jobsity-challenge/pkg/api/auth/transport"
...
func TestLogin(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			wantResp: &jobsity.AuthToken{Token: "jwttokenstring", RefreshToken: "refreshtoken"},
		},
	}
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantResp != nil {
				response := new(jobsity.AuthToken)
...
func TestRefresh(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			wantResp: &jobsity.RefreshToken{Token: "jwttokenstring"},
		},
	}
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			defer res.Body.Close()
			if tt.wantResp != nil {
				response := new(jobsity.RefreshToken)
				if err := json.NewDecoder(res.Body).Decode(response); err != nil {
					t.Fatal(err)
				}
				assert.Equal(t, tt.wantResp, response)
...
func TestMe(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			wantStatus: http.StatusOK,
			udb: &mockdb.User{
				ViewFn: func(db orm.DB, i int) (jobsity.User, error) {
					return jobsity.User{
						Base: jobsity.Base{
							ID: i,
						},
